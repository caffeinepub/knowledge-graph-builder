...
const JSON_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <p className="text-muted-foreground">
      Подходит для программной обработки и интеграции с другими системами.
    </p>
  </div>
);
...
const CSV_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <ul className="space-y-0.5 list-none">
      <li>
        • <span style={{ color: "oklch(0.82 0.19 195)" }}>triplets.csv</span> —
        все триплеты с весами
      </li>
      <li>
        • <span style={{ color: "oklch(0.78 0.19 75)" }}>ontology.csv</span> —
        онтологические связи с уверенностью
      </li>
    </ul>
    <p className="text-muted-foreground">
      Подходит для анализа в Excel, Google Sheets или Python/pandas.
    </p>
  </div>
);
...
const EXCEL_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <ul className="space-y-0.5 list-none">
      <li>
        • <span style={{ color: "oklch(0.82 0.19 195)" }}>Триплеты</span> —
        семантические тройки
      </li>
      <li>
        • <span style={{ color: "oklch(0.78 0.19 75)" }}>Таксономия</span> —
        иерархия (плоский список)
      </li>
      <li>
        • <span style={{ color: "oklch(0.65 0.22 300)" }}>Онтология</span> —
        типизированные связи
      </li>
    </ul>
    <p className="text-muted-foreground">
      Подходит для ручного просмотра, отчётов и презентаций.
    </p>
  </div>
);
