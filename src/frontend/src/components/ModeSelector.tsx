...
const GLOBAL_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <p className="text-muted-foreground">
      Используйте, когда нужна общая картина связей между всеми терминами без
      разбивки по темам.
    </p>
  </div>
);
...
const INTENT_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <p>
      Каждая группа запросов обрабатывается отдельно, создавая индивидуальный
      граф для каждого намерения.
    </p>
    <p>
      Дополнительно строится мета-граф, показывающий связи между кластерами
      намерений.
    </p>
    <p className="text-muted-foreground">
      Используйте, когда нужно сравнить тематические кластеры или изучить каждую
      группу отдельно.
    </p>
  </div>
);
