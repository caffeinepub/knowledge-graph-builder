...
const GRAPH_SELECTOR_TOOLTIP = (
  <div className="space-y-1.5">
    ...
    <p>
      <span style={{ color: "oklch(0.65 0.22 300)" }}>Мета-граф</span> —
      показывает высокоуровневые связи между кластерами намерений. Полезен для
      понимания тематической структуры всего набора запросов.
    </p>
    <p>
      <span style={{ color: "oklch(0.78 0.19 75)" }}>Граф намерения N</span> —
      детальный граф знаний для конкретной группы запросов. Позволяет углублённо
      изучить отдельную тему.
    </p>
    <p className="text-muted-foreground">
      Переключайтесь между графами для сравнения тематических кластеров.
    </p>
  </div>
);
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex items-center gap-1">
        ...
        <TooltipIcon
          content={GRAPH_SELECTOR_TOOLTIP}
          side="right"
          align="start"
        />
      </div>
          ...
          style={
            selectedIndex === "meta"
              ? {
                  ...
                  borderColor: "oklch(0.65 0.22 300 / 0.6)",
                }
              : {}
          }
        >
